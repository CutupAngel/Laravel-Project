  ...
  <div class="row">
    <div class="col-12">
      <div class="page-title-box">
        <div class="page-title-right"><a href="{{route('department_client')}}" class="btn app-btn-primary">Back</a></div>
    ...
    <div class="col-12">
      <div class="app-card app-card-progress-list h-100 shadow-sm">
        <div class="app-card-body p-4">
          ...
          <form method="POST" action="{{route('department_client_update', $client->id)}}" enctype="multipart/form-data">
            @csrf
            <div class="row">
              <div class="col-md-6">
                <div class="mb-3">
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" value="{{$client->days}}" id="simpleinput" class="form-control @error('days') is-invalid @enderror" name="days" required>
                </div>
