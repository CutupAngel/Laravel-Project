        ...
        <div class="app-card-body p-4">
          ...
          <div class="page-aside-left">
            ...
            <div class="email-menu-list mt-3">
              <a href="{{route('message_inbox')}}" class="text-danger font-weight-bold"><i class="dripicons-inbox mr-2"></i>Inbox</a>
                  ...
                  <div class="email-action-icons">
                    <ul class="list-inline">
                      <li class="list-inline-item">
                        <a href="{{route('inbox_destroy',$message->id)}}"><i class="mdi mdi-delete email-action-icons-item"></i></a>
                      </li>
                    </ul>
                  </div>
                </li>
