...
<head>
  <meta charset="utf-8" />
  <title>HomeTownSecurity | blade account</title>
      ...
      <div class="sidepanel-inner d-flex flex-column">
        ...
        <nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
          <ul class="app-menu list-unstyled accordion" id="menu-accordion">
            <li class="nav-item">
              <a class="nav-link {{ (request()->is('account/dashbord')) ? 'active' : '' }}" href="{{route('account')}}">
                <span class="nav-icon">
            ...
            <!--//nav-item-->
            <li class="nav-item">
              <a class="nav-link {{ (request()->is('account/report')) ? 'active' : '' }}" href="{{route('account_report')}}">
                <span class="nav-icon">
            ...
            <!--//nav-item-->
            <li class="nav-item has-submenu" href="{{route('account_user')}}">
              <a class="nav-link submenu-toggle {{ (request()->is('account/user')) || (request()->is('account/user/create')) ? 'active' : '' }}" href="#" data-bs-toggle="collapse" data-bs-target="#submenu-1" aria-expanded="false" aria-controls="submenu-1">
                <span class="nav-icon">
              ...
              <!--//nav-link-->
              <div id="submenu-1" class="collapse submenu submenu-1  {{ (request()->is('account/user')) || (request()->is('account/user/create')) ? 'show' : '' }}" data-bs-parent="#menu-accordion">
                <ul class="submenu-list list-unstyled">
                  <li class="submenu-item">
                    <a class="submenu-link  {{ (request()->is('account/user'))  ? 'active' : '' }}" href="{{route('account_user')}}">
                      Users List
                    </a>
                  </li>
                  <li class="submenu-item">
                    <a class="submenu-link  {{ (request()->is('account/user/create')) ? 'active' : '' }}" href="{{route('account_user_create')}}">
                      Create User
                    </a>
                  </li>
                </ul>
            ...
            <!--//nav-item-->
            <li class="nav-item has-submenu" href="{{route('account_client')}}">
              <a class="nav-link submenu-toggle {{ (request()->is('account/client')) || (request()->is('account/client/create')) ? 'active' : '' }}" href="#" data-bs-toggle="collapse" data-bs-target="#submenu-2" aria-expanded="false" aria-controls="submenu-2">
                <span class="nav-icon">
              ...
              <!--//nav-link-->
              <div id="submenu-2" class="collapse submenu submenu-2  {{ (request()->is('account/client')) || (request()->is('account/client/create')) ? 'show' : '' }}" data-bs-parent="#menu-accordion">
                <ul class="submenu-list list-unstyled">
                  <li class="submenu-item">
                    <a class="submenu-link  {{ (request()->is('account/client'))  ? 'active' : '' }}" href="{{route('account_client')}}">
                      Clients
                    </a>
                  </li>
                  <li class="submenu-item">
                    <a class="submenu-link  {{ (request()->is('account/client/create')) ? 'active' : '' }}" href="{{route('account_client_create')}}">
                      Create Client
                    </a>
                  </li>
                </ul>
