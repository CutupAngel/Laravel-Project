...
<head>
  <meta charset="utf-8" />
  <title>HomeTownSecurity | staff blade</title>
      ...
      <div class="sidepanel-inner d-flex flex-column">
        ...
        <nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
          <ul class="app-menu list-unstyled accordion" id="menu-accordion">
            ...
            <!--//nav-item-->
            <li class="nav-item">
              <a class="nav-link {{ (request()->is('staff/report')) ? 'active' : '' }}" href="{{route('staff_report')}}">
                <span class="nav-icon">
            ...
            <!--//nav-item-->            
            <li class="nav-item">
              <a class="nav-link {{ (request()->is('staff/patrol')) ? 'active' : '' }}" href="{{route('staff_patrol')}}">
                <span class="nav-icon">
