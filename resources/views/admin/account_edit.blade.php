...
<div class="d-flex align-items-center justify-content-between">
  <h1 class="app-page-title mb-0">Users / Update</h1>
...
<div class="row g-4 settings-section">
  <div class="col-12 col-md-4">
    <h3 class="section-title">Update User3</h3>
    <div class="section-intro">
      Update User Name, Email, Phone, Password & Photo
    </div>
  </div>
  <div class="col-12 col-md-8">
    <div class="app-card app-card-settings shadow-sm p-3">
      <div class="app-card-body p-4">
        <form class="settings-form" method="POST" action="{{route('admin_account_update',$user->id)}}" enctype="multipart/form-data">
          @csrf
          <div class="row">
            <div class="col-md-12">
              <div class="mb-3">
