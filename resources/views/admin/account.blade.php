...
<div class="app-card app-card-orders-table h-100 shadow-sm">
  <div class="app-card-header p-3">
    <div class="row justify-content-between align-items-center">
      ...
      <div class="col-auto">
        <a href="{{route('admin_account_create')}}" class="btn app-btn-primary">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="cell pe-3 pe-md-3">
              <a class="btn-sm app-btn-secondary me-2" href="{{ route('admin_account_edit',$user->id) }}">
              ...
              <a class="btn-sm app-btn-secondary border-danger text-danger" href="{{ route('admin_account_delete',$user->id) }}">
