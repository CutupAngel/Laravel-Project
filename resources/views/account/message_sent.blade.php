...
<div class="d-flex align-items-center justify-content-between">
  <h1 class="app-page-title mb-0">Sent Emails</h1>
    ...
    <div class="row">
      ...
      <div class="col-md-3">
        <div class="list-group rounded-0 mail-list">
          <a href="{{route('message_inbox')}}" class="list-group-item list-group-item-action {{ (request()->is('message/inbox')) ? 'active' : '' }}">
          ...
          <a href="{{route('message_sent')}}" class="list-group-item list-group-item-action d-flex align-items-center justify-content-between {{ (request()->is('message/sent')) ? 'active' : '' }}">
            <span class="d-flex align-items-center">
            ...
            <li class="mail list-group-item list-group-item-action shadow-sm p-3 mb-1" aria-current="true">
              <div class="d-flex w-100 justify-content-between align-items-center">
                <a href="#" type="button" class="text-primary w-100" data-bs-toggle="modal" data-bs-target="#message_detail_model" data-bs-subject="{{$message->subject}}" data-bs-content="{{$message->content}}" data-bs-date="{{$message->created_at}}">
                  ...
                  <!-- <a href="{{route('message_show',$message->id)}}" class="text-primary w-100"> -->
                  <!-- <h6 class="name mb-1">
                    {{$message->subject}}
                  </h6> -->
