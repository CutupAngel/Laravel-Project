...
<div class="d-flex align-items-center justify-content-between">
  ...
  <a href="{{route('account_user')}}" class="btn app-btn-secondary mb-2">
  ...
  <div class="col-12">
    <div class="app-card app-card-settings shadow-sm p-3">
      <div class="app-card-body p-4">
        <form class="settings-form" method="POST" action="{{route('account_user_store')}}" enctype="multipart/form-data">
          @csrf
          <div class="row">
            <div class="col-md-12">
              <div class="mb-3">
            ...
            <div class="col-md-6">
              <div class="mb-3">
                ...
                <input type="text" class="form-control @error('phone') is-invalid @enderror" name="phone" value="{{ old('email') }}" required />
              </div>
            </div>
            <div class="col-md-6">
              <div class="mb-3">
